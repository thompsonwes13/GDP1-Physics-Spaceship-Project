...
//		return false;
//	}
	if (drawInfo.meshName == "assets/models/Sphere_radius_1_xyz_N.ply" || 
		drawInfo.meshName == "assets/models/Flat_Plane_xyz_N.ply" ||
		drawInfo.meshName == "assets/models/Cube_xyz_N.ply" ||
		drawInfo.meshName == "assets/models/spaceship/SM_Bld_Hanger_01_NO_DOORS_or_WINDOWS_flatshaded_xyz_n.ply")
	{
	...
	else if (drawInfo.meshName == "assets/models/spaceship/SM_Bld_Hanger_01_xyz_n_uv.ply" ||
		     drawInfo.meshName == "assets/models/spaceship/SM_Bld_HangerPlatform_01_xyz_n_uv.ply")
	{
	...
	{
		if (!readPlyFile_XYZ_Normal_RGBA_UV(drawInfo))
		{
			return false;
		}
	}
